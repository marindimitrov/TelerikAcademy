...
class BonusScores
{
    static void Main()
    {
        ...
        switch (score)
        {
            ...
            case 2:
            case 3:
                Console.WriteLine("The score after applied bonus is: {0}", score * 10);
                break;
            case 4:
            case 5:
            case 6:
                Console.WriteLine("The score after applied bonus is: {0}", score * 100);
                break;
            case 7:
            case 8:
            case 9:
                Console.WriteLine("The score after applied bonus is: {0}", score * 1000);
                break;
            default:
                Console.WriteLine("Please enter value between 1 and 9.");
                break;
        }
    }
}